...
class NormalGraph extends StatefulWidget {
  dynamic fromDate;
  dynamic toDate;
   NormalGraph(
      this.fromDate,this.toDate,{super.key});

  @override
  State<NormalGraph> createState() => _NormalGraphState();
}

class _NormalGraphState extends State<NormalGraph> {
